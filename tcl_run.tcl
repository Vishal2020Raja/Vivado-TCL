...
open_run impl_1
report_power > Reports/[string trimright [lindex $argv 0]]/power.txt
report_timing > Reports/[string trimright [lindex $argv 0]]/timing.txt
report_utilization > Reports/[string trimright [lindex $argv 0]]/utilization.txt
